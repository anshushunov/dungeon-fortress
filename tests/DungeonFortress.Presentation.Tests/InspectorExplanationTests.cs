...
public sealed class InspectorExplanationTests
{
    ...
    public void An_unreachable_designation_tells_the_player_to_dig_a_neighbour_first()
    {
        ...
        Assert.Equal(
            ...
            InspectorText.BuildDigExplanation(state, new GridPoint(26, 1)));
    }
    ...
    public void A_designation_blocked_by_priority_reports_the_priority_it_is_blocked_by()
    {
        ...
        Assert.Equal(
            ...
            "result → floor + 1 loose stone",
            InspectorText.BuildDigExplanation(state, new GridPoint(25, 1)));
    }
    ...
    public void Undesignated_diggable_rock_names_the_key_that_designates_it()
    {
        ...
        Assert.Equal(
            ...
            "result → floor + 1 loose stone",
            InspectorText.BuildDigExplanation(state, rock));
    }
    ...
    public void Rock_that_cannot_be_dug_gets_the_terse_reason(int x, int y, string reason)
    {
        ...
        Assert.Equal(
            $"not diggable: {reason}.",
            InspectorText.BuildDigExplanation(state, new GridPoint(x, y)));
    }
    ...
    public void Already_excavated_ground_is_reported_as_excavated_rather_than_as_floor()
    {
        ...
        Assert.Equal(
            ...
            InspectorText.BuildDigExplanation(state, excavated));
    ...
    public void Every_kind_of_tile_reads_differently()
    {
        ...
        Assert.Equal("rock (internal)", InspectorText.TileDescription(fresh, new GridPoint(25, 1)));
        Assert.Equal("rock (map boundary)", InspectorText.TileDescription(fresh, new GridPoint(0, 0)));
        Assert.Equal("floor (excavated)", InspectorText.TileDescription(dug, dug.Map.ExcavatedTiles[0]));
        Assert.Equal("mushroom bed", InspectorText.TileDescription(fresh, fresh.Beds[0].Position));
        Assert.Equal("gate", InspectorText.TileDescription(fresh, new GridPoint(27, 13)));
        Assert.Equal("floor", InspectorText.TileDescription(fresh, new GridPoint(12, 12)));
        var station = fresh.Stations[0];
        Assert.Equal(
            station.Kind.ToString(),
            InspectorText.TileDescription(fresh, station.Position));
    }
    ...
    public void With_nothing_selected_the_panel_explains_who_owns_the_world()
    {
        Assert.Equal(
            ...
            InspectorText.Build(PresentationFixtures.Baseline(1), null, null));
    }
    ...
    public void A_quarters_cell_carries_its_rest_rule_in_the_zone_line()
    {
        ...
        Assert.Contains(
            ...
            InspectorText.Build(state, null, quarters),
    ...
    public void A_selected_creature_leads_with_its_identity_status_and_hit_points()
    {
        ...
        var text = InspectorText.Build(state, creature.Id, creature.Position);
    ...
    public void A_creature_with_no_decision_details_says_none_rather_than_showing_a_blank()
    {
        ...
        var text = InspectorText.Build(state, creature.Id, null);
    ...
    public void A_cell_with_both_a_pile_and_a_stockpile_shows_the_loose_section_first()
    {
        ...
        var text = InspectorText.Build(state, null, cell);
